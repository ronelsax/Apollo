...
namespace Apollo.DataModel
{
    ...
    public abstract class SampleDataCommon : Apollo.Common.BindableBase
    {
    ...
    {
        public static readonly ObservableCollection<SampleDataGroup> AllGroups = new ObservableCollection<SampleDataGroup>();
