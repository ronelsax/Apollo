...
{
    /// <summary>
    /// A page that displays a grouped collection of items AKA the homepage.
    /// </summary>
    public sealed partial class GroupedItemsPage : Apollo.Common.LayoutAwarePage
    {
